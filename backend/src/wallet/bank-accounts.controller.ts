...
export class BankAccountsController {
  ...
  async getBankAccounts(
    ...
    const accounts = await this.bankAccountsService.getBankAccounts(user.userId);
    return { accounts };
  }
  ...
  async addBankAccount(
    ...
    return this.bankAccountsService.addBankAccount(user.userId, body);
  }
  ...
  async deleteBankAccount(
    ...
    await this.bankAccountsService.deleteBankAccount(user.userId, accountId);
  }
  ...
  async setDefaultAccount(
    ...
    await this.bankAccountsService.setDefaultAccount(user.userId, accountId);
